...
探测网络主机存活。
注意:在win7下需要管理员权限
来源网址：http://www.oschina.net/code/snippet_1026590_20802
描述：在网上找的开源扫描程序速度都不尽人意，除了nmap for linux。 因工作需要，所以我自己写了一个，跟大家分享下。
我的这个扫描程序是双线程运行的，一个线程只负责发报文，另一个线程负责收报文，待发送报文的线程结束后再进行计算，所以速度非常之快。
'''
